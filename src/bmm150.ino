...
//     prefs.putBytes("offset", (uint8_t *)&mag_offset,
//     sizeof(bmm150_mag_data)); prefs.end();
// }
...
//         sizeof(bmm150_mag_data)); prefs.end(); Serial.printf("bmm150 load
//         offset finish.... \r\n");
//     }
//     else
//     {
...
//     M5.update();
//     bmm150_read_mag_data(&dev);
//     float head_dir = atan2(dev.data.x -  mag_offset.x, dev.data.y -
//     mag_offset.y) * 180.0 / M_PI; Serial.printf("Magnetometer data, heading
//     %.2f\n", head_dir); Serial.printf("MAG X : %.2f \t MAG Y : %.2f \t MAG Z
//     : %.2f \n", dev.data.x, dev.data.y, dev.data.z); Serial.printf("MID X :
//     %.2f \t MID Y : %.2f \t MID Z : %.2f \n", mag_offset.x, mag_offset.y,
//     mag_offset.z);
